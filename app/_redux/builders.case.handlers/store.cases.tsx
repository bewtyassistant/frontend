...
export const FetchStoreStatisticsCaseHandlers: {
  ...
  fulfilled: (state, action) => {
    ...
    state.totalNumberOfFulfilledAppointments = action.payload.totalNumberOfFulfilledAppointments
    state.totalNumberOfClientsServiced = action.payload.totalNumberOfClientsServiced
    ...
    state.totalNumberOfLocationsDeliveredTo = action.payload.totalNumberOfLocationsDeliveredTo
  },
  rejected: (state) => {
    state.loading = false
  },
